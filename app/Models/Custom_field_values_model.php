...
class Custom_field_values_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        // Log table names and database prefix
        $db_prefix = get_db_prefix();
        log_message('debug', 'Custom Field Values - Database Prefix: ' . $db_prefix);
        log_message('debug', 'Custom Field Values - Table: ' . $custom_field_values_table);
        log_message('debug', 'Custom Fields - Table: ' . $custom_fields_table);
        ...
        // Log query details
        log_message('debug', 'Custom Field Values - Query Options: ' . print_r($options, true));
        log_message('debug', 'Custom Field Values - SQL Query: ' . $sql);

        $result = $this->db->query($sql);
        $rows = $result->getResult();

        // Log query results
        log_message('debug', 'Custom Field Values - Query Result Count: ' . count($rows));
        log_message('debug', 'Custom Field Values - Query Results: ' . print_r($rows, true));
