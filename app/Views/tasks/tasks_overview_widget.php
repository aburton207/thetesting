    ...
    <div class="card-body rounded-bottom" id="<?php echo $type; ?>-widget">
        <div class="row">
            ...
            <div class="col-md-6 pl20 <?php echo count($task_statuses) > 8 ? "" : "pt-4"; ?>">
                ...
                foreach ($task_statuses as $task_status) {
                    ?>
                    <a href="<?php echo get_uri('tasks/all_tasks/tasks_list/' . $task_status->status_id . "/0/$type"); ?>" class="text-default">
                        <div class="pb-2">
                ...
                <?php if ($expired_tasks) { ?>
                    <a href="<?php echo get_uri('tasks/all_tasks/tasks_list/0/0/' . $type . '/expired'); ?>" class="text-default">
                        <div class="pb-2">
                            <div class="color-tag border-circle me-3 wh10" style="background-color: #f5325c"></div><?php echo app_lang("expired"); ?>
                            <span class="strong float-end" style="color: #f5325c"><?php echo $expired_tasks; ?></span>
                        </div>
                    </a>
                <?php } ?>
            </div>
        ...
        <div class="position-absolute d-flex justify-content-between" style="bottom: 15px;">
            ...
            foreach ($task_priorities as $task_priority) {
                ?>
                <span class="me-5">
                    <a href="<?php echo get_uri('tasks/all_tasks/tasks_list/0/' . $task_priority->priority_id . "/$type"); ?>" class="text-default">
