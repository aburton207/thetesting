    ...
    <div class="box mb15">
        <div class="box-content">
            <div class="pt-3 pb-3 text-center">
                <div class=" b-r">
                    <h4 class="mt-0 strong mb5 text-danger"><?php echo $ticket_info->in_message_count ? $ticket_info->in_message_count : 0 ?></h4>
        ...
        <div class="box-content">
            <div class="p-3 text-center">
                <h4 class="mt-0 strong mb5 text-primary"><?php echo $ticket_info->out_message_count ? $ticket_info->out_message_count : 0 ?></h4>
