<div class="tab-content">
    ...
    <div class="card border-top-0 rounded-top-0">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="whatsapp" class=" col-md-2">WhatsApp</label>
                    <div class=" col-md-10">
                        <?php
                        echo form_input(array(
                            "id" => "whatsapp",
            ...
            <div class="form-group">
                <div class="row">
                    <label for="digg" class=" col-md-2">Sales Url</label>
                    <div class=" col-md-10">
                        <?php
                        echo form_input(array(
                            "id" => "digg",
                            ...
                            "class" => "form-control",
                            "placeholder" => "https://avenirenergy.work/collect_leads/index/##region/##user_id"
                        ));
                        ?>
                    </div>
                </div>
                   <div class="row">
                       <label>https://avenirenergy.work/collect_leads/index/##region/##user_id</label></div>
            </div>
            <div class="form-group">
                <div class="row">
