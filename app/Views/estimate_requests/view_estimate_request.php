                        ...
                        <ul class="dropdown-menu float-end" role="menu">
                            <?php if ($login_user->user_type == "staff") { ?>
                                <li role="presentation">
                                    <?php echo modal_anchor(get_uri("estimate_requests/edit_estimate_request_modal_form"), "<i data-feather='user-check' class='icon-16'></i> " . app_lang('assign'), array("title" => app_lang('assign_estimate_request'), "data-post-view" => "details", "data-post-id" => $model_info->id, "class" => "dropdown-item")); ?>
                                </li>
                                <li role="presentation">
                                    <?php echo modal_anchor(get_uri("estimate_requests/edit_estimate_request_content_modal_form"), "<i data-feather='edit' class='icon-16'></i> " . app_lang('edit'), array("title" => app_lang('edit_estimate_request'), "data-post-view" => "details", "data-post-id" => $model_info->id, "class" => "dropdown-item")); ?>
                                </li>
                                <li role="presentation">
                                    <?php echo anchor(get_uri("estimate_requests/download_pdf/" . $model_info->id), "<i data-feather='download' class='icon-16'></i> " . app_lang('download_pdf'), array("title" => app_lang('download_pdf'), "class" => "dropdown-item")); ?>
                                </li>
                            <?php } ?>

                            <?php echo view("estimate_requests/estimate_request_status_options"); ?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive mt20 general-form">
                    <table id="estimate-request-table" class="display no-thead b-t b-b-only no-hover" cellspacing="0" width="100%"></table>
                </div>
                <div class="p15">
                    <?php
                    if ($model_info->files) {
                ...
                <div class="card-body">
                    <table class="display no-thead b-t b-b-only no-hover dataTable no-footer">
                        <tbody>
                            <tr>
                                <td>
                                    <i data-feather="box" class="icon-16"></i><strong> <?php echo app_lang('company_name_custom'); ?></strong>
