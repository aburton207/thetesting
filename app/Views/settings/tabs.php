...
<ul class="nav nav-tabs vertical settings d-block" role="tablist">
    <style>.menuclass_updates,.menuclass_general,.menuclass_localization,.menuclass_left_menu,.menuclass_integration,#settings-tab-plugins,.menuclass_cron_job{display:none!important;}</style>
    <?php
...
echo "<a href='" . get_uri($setting_url) . "' class='list-group-item $active_class menuclass_" . strtolower(str_replace(' ', '_', $setting_name)) . "'>" . app_lang($setting_name) . "</a>";
