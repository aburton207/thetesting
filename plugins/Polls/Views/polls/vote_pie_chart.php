<?php
$chart_id = isset($chart_id) ? $chart_id : "vote-status-chart";
$vote_label = array();
$vote_data = array();
...
<div class="card mt50 b-a">
    <div class="card-body">
        <canvas id="<?php echo $chart_id; ?>" width="400"></canvas>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var voteStatusChart = document.getElementById("<?php echo $chart_id; ?>");
